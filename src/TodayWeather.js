...
export default function TodayWeather(props){
    let today = props.todayInformation
    ...
    return(
        ...
        <div className="weather-big-description">
          <div className="container">
            ...
            <img
              src={`http://openweathermap.org/img/wn/${today.weather[0].icon}@2x.png`} alt={today.weather[0].description}
            />
          </div>
          <div className="container">
            ...
            <div style={{ color: "#34BFED" }}>
              Влажность: {today.humidity}%
            </div>
            <div>
              Ветер: {props.getWindDirection(today.wind_deg)} {today.wind_speed}м/с
            </div>
            <div
              style={
                today.uvi < 8
